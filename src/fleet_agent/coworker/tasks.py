...
from .contribution_watch import run_contribution_dogfood
...
from .grade_watch import run_grade_watch
from .inbox_briefing import run_inbox_briefing
from .morning_brief import run_morning_brief
from .pc_supervision_watch import (
    run_disk_watch,
    run_gpu_vram_watch,
    run_task_backlog_watch,
    run_workflow_health_watch,
)
...
_COWORKER_RUNNERS = {
    ...
    "gpu_vram_watch": run_gpu_vram_watch,
    "workflow_health_watch": run_workflow_health_watch,
    "task_backlog_watch": run_task_backlog_watch,
    "disk_watch": run_disk_watch,
    "contribution_dogfood": run_contribution_dogfood,
}
